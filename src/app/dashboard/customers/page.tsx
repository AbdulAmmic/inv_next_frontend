          ...
          <div className="md:hidden flex flex-col divide-y divide-slate-100/50">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex justify-between items-start">
                        ...
                        <button className="p-2 -mr-2 text-slate-400 hover:text-slate-900 transition-colors">
                          <MoreVertical className="w-4 h-4" />
                        </button>
                      </div>
                      <div className="flex items-center gap-1.5 mt-0.5">
                        <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
                        <p className="text-slate-400 text-xs font-bold uppercase tracking-wider italic truncate">Loyal Client</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-50/50 rounded-xl p-3 space-y-2">
                    {customer.email && (
                      <div className="flex items-center gap-3 text-slate-600">
                        <div className="p-1.5 rounded-lg bg-blue-50/50 text-blue-500">
                    ...
                    {customer.phone && (
                      <div className="flex items-center gap-3 text-slate-600">
                        <div className="p-1.5 rounded-lg bg-emerald-50/50 text-emerald-500">
                          <PhoneIcon className="w-3.5 h-3.5" />
                        </div>
                        <span className="text-xs font-medium truncate">{customer.phone}</span>
                      </div>
                    )}
                    {!customer.email && !customer.phone && (
                      <span className="text-slate-400 text-xs italic font-medium">No contact details</span>
                    )}
                  </div>

                  <div className="flex items-center justify-between mt-1 text-slate-500 text-xs">
                    <span className="font-bold uppercase tracking-wider text-[10px]">Joined</span>
            ...
            {filteredCustomers.length === 0 && (
              <div className="p-12 text-center flex flex-col items-center">
                ...
                <h3 className="font-extrabold text-slate-900">No customers found</h3>
                <p className="text-slate-400 text-xs mt-2 font-medium">
                  {searchTerm ? "Try refining your search terms." : "Your community is waiting."}
                </p>
                {!searchTerm && (
                  <button
                    onClick={() => setShowModal(true)}
